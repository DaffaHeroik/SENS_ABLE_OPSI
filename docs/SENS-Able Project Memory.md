...
## 20. Public Dataset Search and Augmentation Experiment (26 Agustus 2026)
A search of authoritative public sources identified several dataset categories. The Mazandaran/Mendeley dataset has 67 green-PPG records from 23 people with invasive glucose labels and CC BY 4.0, but its APDS9008 green sensor and 2175 Hz sampling differ substantially from MAX30102 SENS-Able. PhysioCGM has ECG, Empatica E4 PPG/EDA/skin temperature, and Dexcom CGM for 10 type-1-diabetes participants, but the complete Figshare download is about 23.32 GB. BIG IDEAs Lab has 16 participants with E4 BVP/HR/EDA/skin temperature and Dexcom CGM, under ODC Attribution, with about 34.1 GB uncompressed. OhioT1DM requires institutional-email access and is mainly a CGM/insulin/context forecasting dataset without PPG. D1NAMO is a 10.2 GB ECG/breathing/accelerometer/glucose dataset without PPG. Glucdict is a 4.7 GB smartwatch/CGM/context dataset without raw PPG. These are useful references or future benchmark sources, but they are not direct replacements for SENS-Able data.

The most directly compatible small public source was the Zenodo STU PPG Blood Glucose Dataset (DOI 10.5281/zenodo.21978226, CC0). It contains 125 records from 24 volunteers, six PPG channels at 530/655/940 nm, accelerometry, and capillary glucometer labels in mmol/L. The archive and QC files were downloaded and parsed outside the repository. 105 records passed the supplied QC and parsing checks, representing 18 subjects, with labels spanning 39.64–304.5076 mg/dL after transparent conversion.

An external augmentation script was added at `ai_final/improvement/external_public_ppg_experiment.py`. It uses only 10 features available in both sources, keeps the SENS-Able GroupKFold-by-SubjectID holdout, and never changes `GlukosaRef`. On the shared-feature SENS-Able holdout, SENS-Able-only training achieved MAE 22.1055 mg/dL, public-plus-SENS-Able training achieved 25.8117 mg/dL, and the best weighted public augmentation (public weight 0.1) achieved 23.1664 mg/dL. Public-only training achieved MAE 49.6547 mg/dL. Therefore, online data was genuinely tested but did not improve the physical-device model under this protocol. The canonical 22-feature V0.1 model remains unchanged. The new public-data quality gate produced **15 tests PASS**.
## 21. Clarification on Physical Audio and Vibration Integration (26 Agustus 2026)
The researcher clarified that audio and vibration are already completed and integrated into one physical SENS-Able device. The missing evidence is not assembly, but formal functional testing, response testing, and accessibility/usability testing with valid logs or participant data. Future proposal wording must therefore describe audio and vibration as implemented device components while limiting claims about effectiveness, accessibility benefit, and usability until those tests are available. Lack of valid glucose-reference data affects the glucose-model evaluation separately; it does not prevent a bench functional test of audio/vibration using controlled test inputs, but such a test must not be presented as clinical glucose validation.
