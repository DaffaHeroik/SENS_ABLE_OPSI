...
| Validasi regresi saat ini | Setelah mempertahankan sesi dengan suhu nol yang optiknya valid dan mengimputasi suhu secara transparan, GroupKFold berdasarkan `SubjectID` menghasilkan MAE 22,4158 mg/dL, RMSE 27,0395 mg/dL, R² 0,0625 | Hasil ini masih eksploratif; belum memenuhi target MAE <15 mg/dL dan tidak boleh disebut akurasi klinis |
